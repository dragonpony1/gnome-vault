...
const CACHE = "mahj-helper-15";
const FILES = ["./", "./index.html", "./engine.js", "./hands.js", "./manifest.webmanifest", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png", "./font-brush.woff2", "./font-hanzi.woff2"];
