...
check("map 2 is the throne room: 46×55 under a 14-high ceiling with windows, three gates with long paths (≥30), crystal six up, terrace three up, grand and upper stairs step between them, tavern re-homed",r3.map.index===1&&r3.map.gw===46&&r3.map.wallH===14&&r3.map.windows>=6&&r3.lanes.join()==="W,E,S"&&Object.values(r3.paths).every(p=>p>=30)&&r3.crystalH===6&&r3.terrace===3&&r3.stairTop>=2.5&&r3.stairBottom<=.5&&r3.upperStair>3&&r3.upperStair<6&&r3.floorBelow===0&&r3.stations===5&&/MAP 2 OF 4/.test(r3.line)&&r3.wbase===7,JSON.stringify(r3));
