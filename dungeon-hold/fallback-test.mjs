...
await page.goto("http://127.0.0.1:8849/?silent&nogate"); await page.waitForFunction(()=>window.__dd&&window.__dd.heroModel(),null,{timeout:60000}); await page.waitForTimeout(5000);
