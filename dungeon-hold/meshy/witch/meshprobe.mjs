...
await page.goto("http://127.0.0.1:8877/meshprobe.html"); await page.waitForFunction(()=>window.probe); const r=await page.evaluate(()=>window.probe()); console.log(JSON.stringify(r)); await browser.close(); server.close();
